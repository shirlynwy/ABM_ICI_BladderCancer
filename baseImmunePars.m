...
%% event parameters
immune_pars.prolif_rate = 0.5; % immune proliferation rate per day
...
immune_pars.aicd_rate = 24; % chosen such that it happens on the order of hours

%% recruitment parameters
immune_pars.immune_recruit_rate = 0.1; % immune cells recruited per tumor cell per day
...
immune_pars.immune_recruit_rate2 = 10; % immune cells recruited per day
